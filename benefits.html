...
<div class="wrap">
  ...
  <div class="banner" style="background:url(images/resource/banner-1.jpg);">
    <div class="container">
      <h1>Benefit of the Fellowship</h1>
      ...
      <div class="span9">
        <section class="blog-box">
          <div class="details">
           ...
           <p><h4>Benefit of the Fellowship</h4></p>
                     ...
                     <p>Upon successful completion of BMF you will be offered a Certificate of Professional Training in Business Management and Public Service Integrity which can be used to take further professional programs offered by UK Association of Business Executives (ABE) through Enterprise Institute. </p>
